export default {
  ...
  'On': 'On',
  'Off': 'Off',
  'Failed to change thinking mode': 'Failed to change thinking mode',
  ...
  'Computing indicators': 'Computing indicators',
  'Running backtest': 'Running backtest',
  'Analyzing portfolio risk': 'Analyzing portfolio risk',
